...
class ll_ATS(unittest.TestCase):
    ...
    def test_ll(self):
        ...
        time.sleep(3)
        elem = driver.find_element_by_xpath("/html/body/div[2]/div/table/tbody/tr[1]/td[4]/a").click()


        # assert "Logged in"
        try:
            # find empty cart body
            elem = driver.find_element_by_xpath("/html/body/div[2]/div/table/tbody/tr/td[2]")
